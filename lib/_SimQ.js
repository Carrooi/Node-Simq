...
(function() {
  ...
  SimQ = (function() {
    ...
    function SimQ(basePath) {
      ...
      this.packages = {};
      if (!fs.existsSync(this.basePath + '/package.json')) {
        throw new Error(this.basePath + '/package.json file does not exists.');
      }
    }
    ...
    SimQ.prototype.buildPackage = function(name) {
      ...
      return (new Builder(this.packages[name])).build();
    };
    ...
    SimQ.prototype.buildPackageToFile = function(name) {
      ...
      this.buildPackage(name).then(function(data) {
        if (data.js !== null) {
          fs.writeFileSync(_this.packages[name].application, data.js);
        }
        if (data.css !== null) {
