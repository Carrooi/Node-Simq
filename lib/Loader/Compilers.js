...
(function() {
  var Compilers, Q, coffee, eco, exec, fs, less, path, sass, stylus,
  ...
  Compilers = (function() {
    ...
    Compilers.prototype.tsLoader = function(content, file) {
      ...
      exec('node ' + ts + ' ' + file + ' --out ' + fileName, function(e, stdout, stderr) {
        if (e) {
          return deferred.reject(_this.parseTsError(e, file));
        } else {
          return fs.readFile(fileName, 'utf-8', function(e, content) {
            fs.unlink(fileName);
            if (e) {
              return deferred.reject(e);
            } else {
              return _this.prepare(fileName, content).then(function(content) {
                return deferred.resolve(content);
              }, function(e) {
                return deferred.reject(e);
              });
    ...
    Compilers.prototype.scssLoader = function(content, file) {
      var deferred, e;
      deferred = Q.defer();
      try {
        ...
        e = _error;
        deferred.reject(this.parseSassError(e, file));
      }
      return deferred.promise;
    };
    ...
    Compilers.prototype.tsCompiler = function(content) {
      return Q.resolve('return (function() {\n' + content + '\n\t\t}).call(this);');
    };
    ...
    Compilers.prototype.parseSassError = function(e, file) {
      var data, err, line, message;
      data = e.message.split('\n')[0].match(/^\:(\d+)\:\serror\:\s(.*)/);
      line = data[1];
      message = data[2];
    ...
    Compilers.prototype.parseTsError = function(e, file) {
      var err;
