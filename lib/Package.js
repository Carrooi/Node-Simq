...
(function() {
  var Helpers, Package, Q, fs, path, required;
  ...
  Package = (function() {
    ...
    Package.isInModule = function(_path) {
      return _path.lastIndexOf('/node_modules/') !== -1;
    };

    Package.getModuleName = function(_path) {
      var buf;
    ...
    Package.getModuleBaseDir = function(_path) {
      if (!this.isInModule(_path)) {
        return null;
      }
      return _path.substr(0, _path.lastIndexOf('/node_modules/') + 14) + this.getModuleName(_path);
    };

    Package.resolveModuleName = function(_path) {
    ...
    Package.findModulePackageFile = function(_path) {
      if (!this.isInModule(_path)) {
        return null;
      }
      return this.getModuleBaseDir(_path) + '/package.json';
    };

    Package.loadModuleInfo = function(_path) {
    ...
    Package.findDependencies = function(_path) {
    ...
    Package.parseDependencies = function(dep) {
    ...
    Package.findDependenciesForModules = function(paths) {
    ...
    Package.getGlobalsForModule = function(name) {
    ...
    Package.parseNodeInfo = function(data, basePath) {
      var info, m, main, name, result;
      result = {};
      for (m in data) {
        info = data[m];
