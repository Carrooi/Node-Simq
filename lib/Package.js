...
(function() {
  var Finder, Helpers, Package, Q, fs, path, required;
  ...
  Package = (function() {
    ...
    Package.prototype.isInModule = function(_path) {
      var pckg;
      pckg = Finder["in"](path.dirname(_path)).lookUp(this.basePath).findFirst().findFiles('package.json');
    ...
    Package.prototype.findModulePackageFile = function(_path) {
      if (!this.isInModule(_path)) {
        return null;
      }
