...
(function() {
  var Application, Finder, Q, Uglify, _path;
  ...
  Application = (function() {
    ...
    Application.prototype.parse = function(section) {
      var base, processLib,
        _this = this;
      base = this.basePath + '/' + (section.base ? section.base + '/' : '');
      processLib = function(result, libs, num, finish, error) {
        var file;
        ...
        return _this.loader.loadFile(file).then(function(content) {
          ...
          return processLib(result, libs, num + 1, finish, error);
        }, function(e) {
          return error(e);
        });
      };
      return (function() {
        ...
        var asterisk, baseDir, buf, deferred, filter, mask, path, _i, _len, _ref;
        buf = [];
