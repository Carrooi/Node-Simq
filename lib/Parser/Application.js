...
(function() {
  ...
  Application = (function() {
    ...
    function Application(simq, loader, basePath, section, backageName) {
      this.simq = simq;
      this.loader = loader;
    ...
    Application.prototype.parseLibraries = function(type) {
      return Helpers.loadLibraries(this.loader, this.section.libs[type], this.basePath);
    };
    ...
    Application.prototype.parseModules = function() {
      var deferred,
        _this = this;
      deferred = Q.defer();
      Helpers.findDependentModulesFromList(this.section.modules, this.basePath).then(function(data) {
        return Helpers.loadModules(_this.loader, data.files, _this.section.base).then(function(modules) {
          ...
          return _this.loader.loadFile(__dirname + '/../Module.js').then(function(content) {
            var base, info, main, name, node, result, _ref1;
            content = content.replace(/\s+$/, '').replace(/;$/, '');
            base = path.resolve(_this.basePath);
            node = {};
            _ref1 = data.node;
            for (module in _ref1) {
              info = _ref1[module];
