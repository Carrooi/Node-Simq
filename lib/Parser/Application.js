...
(function() {
  ...
  Application = (function() {
    ...
    Application.prototype.loadCoreModules = function() {
      var deferred, deps, expanded, m, modules, name, promises, _i, _j, _len, _len1, _ref;
      deferred = Q.defer();
      ...
      modules = {};
      for (_j = 0, _len1 = expanded.length; _j < _len1; _j++) {
        m = expanded[_j];
        modules[m] = this.pckg.findSystemNodeModulePath(m);
      }
      promises = [];
      for (name in modules) {
        path = modules[name];
        promises.push(this.loader.loadModule(path, null, name));
      }
