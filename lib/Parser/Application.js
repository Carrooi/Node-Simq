    ...
    Application.prototype.parse = function(section, minify) {
      ...
      return (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          lib = _ref[_i];
          result.push(_this.loader.loadFile(base + lib));
        }
        deferred = Q.defer();
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (name.substring(name.length - 1) === '/') {
            modules = modules.concat(_this.loader.loadModules(_this.basePath + '/' + name, ext, section.base));
          } else {
            modules.push(_this.loader.loadModule(_this.basePath + '/' + path, section.base));
          }
        }
