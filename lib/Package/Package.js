  ...
  Package = (function() {
    ...
    Package.prototype.prepare = function() {
      ...
      if (this.initialized === false) {
        if (!this.ignore.packageFiles) {
          this.addModule(this.getPackageInfo().getPackagePath());
        }
        if (!this.ignore.mainFiles) {
        ...
        if (typeof dependencies === 'object' && this.autoNpmModules) {
          ...
          for (name in dependencies) {
            ...
            pckg = new Info(_path);
            if (this.ignore.packageFiles === false) {
              this.addModule(pckg.getPackagePath());
            }
            if (this.ignore.mainFiles === false && (main = pckg.getMainFile()) !== null) {
              this.addModule(main);
            }
            this.registerNodeModule(pckg.getPath());
          }
        }
