...
(function() {
  var Builder, Compiler, Helpers, Info, Package, Q, fs, path, required,
  ...
  Builder = (function(_super) {
    ...
    Builder.prototype.loadForAutorun = function(_path) {
      var deferred, name;
      deferred = Q.defer();
      name = this.pckg.resolveRegisteredModule(_path);
      if (name === null) {
    ...
    Builder.prototype.prepareModules = function() {
      var deferred, mainInfo, paths, _i, _len, _path, _ref;
      deferred = Q.defer();
      paths = [];
      ...
      mainInfo = new Info(this.pckg.getBasePath());
      required.findMany(paths, true, require('../../data.json').supportedCores).then(function(data) {
        var file, info, name, result, _j, _k, _len1, _len2, _ref1, _ref2;
        result = {};
    ...
    Builder.prototype.compileModule = function(name, _path) {
      var deferred,
        _this = this;
      deferred = Q.defer();
      Compiler.compileFile(_path).then(function(result) {
        var globals, type;
